...
public class CheckBoxEventTest extends Frame {
    ...
    CheckBoxEventTest(String title){
        ...
        q1 = new Label("1. 다음 중 ActionEvent의 actionPerformed 메서드가 호출되는 경우는?(모두 고르시오)");
        q1cb1 = new Checkbox("Button을 눌렀을 때");
        q1cb2 = new Checkbox("TestField에서 Enter키를 눌렀을 때");
        q1cb3 = new Checkbox("MenuItem을 더블클릭 했을 때");
